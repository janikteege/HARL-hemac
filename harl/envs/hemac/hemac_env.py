...
class HeMACEnv:
    def __init__(self, args):
        ...
        self.share_observation_space = [self.get_state_space() for _ in self.agents]
    ...
    def step(self, actions):
        ...
        state = self._get_state_curated()
        share_observations = [state for _ in self.agents]

        # total_reward = sum(rewards.values())
        # team_rewards = [[total_reward]] * self.n_agents
        individual_rewards = [[rewards[agent]] for agent in self.agents]
        return (
